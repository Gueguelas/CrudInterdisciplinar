...
//          Conectando com o db
            conexao.conectar();
//          Comando SQL
            pstmt = conexao.getConn().prepareStatement("UPDATE CURRICULO SET cInfosGerais = ? WHERE sId = ?");
//          Argumentos
            pstmt.setString(1, infosGerais);
            pstmt.setInt(2, id);
            if (pstmt.executeUpdate() > 0){
...
//          Conectando com o db
            conexao.conectar();
//          Comando SQL
            pstmt = conexao.getConn().prepareStatement("UPDATE CURRICULO SET cProjetos = ? WHERE sId = ?");
//          Argumentos
...
//          Conectando com o db
            conexao.conectar();
//          Comando SQL
            pstmt = conexao.getConn().prepareStatement("UPDATE CURRICULO SET cHabilidades = ? WHERE sId = ?");
//          Argumentos
...
//          Conectando com o db
            conexao.conectar();
//          Comando SQL
            pstmt = conexao.getConn().prepareStatement("UPDATE CURRICULO SET dDataAtualizacao = ? WHERE sId = ?");
//          Argumentos
...
//          Conectando com o db
            conexao.conectar();
//          Comando SQL
            pstmt = conexao.getConn().prepareStatement("UPDATE CURRICULO SET cLinkLinkedin = ? WHERE sId = ?");
//          Argumentos
...
//          Conectando com o db
            conexao.conectar();
//          Comando SQL
            pstmt = conexao.getConn().prepareStatement("UPDATE CURRICULO SET cTelefone = ? WHERE sId = ?");
//          Argumentos
